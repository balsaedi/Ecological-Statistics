...
<!--chapter:end:02-hypothesis_testing.Rmd-->
...
<!--chapter:end:03-autocorrelation_and_temporal_effects_testing.Rmd-->
...
<!--chapter:end:04-correlation_covariance_geostatistics.Rmd-->
...
<!--chapter:end:05-linear_regression_analysis.Rmd-->
...
<!--chapter:end:06-conventional_and_probabilistic_risk_assessment.Rmd-->
